...
$large_img_src = $grid_gutter = '';

$attributes = vc_map_get_attributes( $this->getShortcode(), $atts );
extract( $attributes );

$_grid_gutter = (!empty($grid_gutter)) ? $grid_gutter : '30px';
...
if ( 'nivo' === $type ) {
	...
	$el_start = '<li class="" style="margin: 0 '. $_grid_gutter .' '. $_grid_gutter .' 0 !important;">';
	$el_end = '</li>';
	$slides_wrap_start = '<ul class="cms-popup-gallery wpb_image_grid_ul " style="margin-right: -'. $_grid_gutter .'  !important;">';
	$slides_wrap_end = '</ul>';
}
