 ...
 */
$el_class = $message_box_color = $message_box_style = $style = $css = $color = $css_animation = $icon_type = $message_remove_icon = '';
...
$message_remove_icon = (!empty($atts['message_remove_icon'])) ? 'remove-icon' : '';
