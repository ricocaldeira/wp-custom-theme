 ...
 * @version 1.0
 * @package WpElementy
 * @since   WpElementy 1.0
 */

class WpElementy_Simple_Post_Like
{
    ...
    {
        wp_enqueue_script( 'haswell-simple-like', get_template_directory_uri() . '/assets/js/simple.likes.js', array( 'jquery' ), '1.0', true );
        wp_localize_script( 'haswell-simple-like', 'WPElementySimpleLike', array(
            'ajaxurl' => admin_url( 'admin-ajax.php' ),
            'like' => esc_html__( 'Like', 'wp-elementy' ),
            'unlike' => esc_html__( 'Unlike', 'wp-elementy' )
        ) );
    }
    ...
    static function process_simple_like()
    {
        ...
        if ( ! wp_verify_nonce( $nonce, 'simple-likes-nonce' ) ) {
            exit( esc_html__( 'Not permitted', 'wp-elementy' ) );
        }
    ...
    static function get_like_count_markup( $like_count )
    {
        ...
        $count = sprintf('<i class="icon_heart_alt"></i> %1$s', $number);
...
new WpElementy_Simple_Post_Like();